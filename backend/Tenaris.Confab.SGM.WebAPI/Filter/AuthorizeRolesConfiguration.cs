...
namespace Tenaris.Confab.SGM.WebAPI.Filter
{
    ...
    public sealed class AuthorizeRolesConfigurationAttribute : ActionFilterAttribute
    {
        public override void OnActionExecuting(HttpActionContext filterContext)
        {


            var requiredRoles = Properties.Settings.Default.GroupsAdmConfiguration.Cast<string>().ToList();
